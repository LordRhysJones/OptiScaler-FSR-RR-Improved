...
set ShaderName=%1
for %%F in ("%ShaderName%") do set "ShaderBaseName=%%~nF"
...
python "%~dp0create_header.py" "%ShaderName%_Shader.cso" "%ShaderName%_Shader.h" %ShaderBaseName%_cso
...
python "%~dp0create_header.py" "%ShaderName%_Shader_Dx11.cso" "%ShaderName%_Shader_Dx11.h" %ShaderBaseName%_cso