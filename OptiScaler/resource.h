...
// Fork identity
#define VER_FORK_NAME "OptiRR"
#define VER_FORK_AUTHORS "Taran Jones & Rhys Jones"
#define VER_UPSTREAM_NAME "OptiScaler"

#define VER_PRODUCT_NAME VER_FORK_NAME " v" VER_PRODUCT_VERSION_STR
